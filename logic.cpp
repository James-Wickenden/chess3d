...
vector<int> LogicEngine::convert_chessboard_square_to_int(string position)
{
	vector<int> res;
...
void LogicEngine::switch_pieces(Chessboard *cb, vector<int> target_position, vector<int> destination_position)
{
